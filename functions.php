...
function nii_framework_setup() {
	 ...
	 */
	require_once 'options/bootstrap.php';
	/**
...
function nii_framework_scripts() {
	...
	wp_enqueue_script( 'uikit-grid', get_template_directory_uri() . '/uikit/js/components/grid.min.js', array(),'2.18.0' );
	//wp_enqueue_script( 'waves-btn', get_template_directory_uri() . '/js/waves.js', array(), '20120206',true);
